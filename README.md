...
### SploitXShakox with Metasploit Integration.
...
The goal of this project is to make penetration testing and vulnerability assessment on Android devices easy. Now you don't have to learn commands and arguments, SploitXShakox does it for you. Using this tool, you can test the security of your Android devices easily.
...
> [!IMPORTANT]
> **SploitXShakox** requires Python version __3.10 or higher__. Please update Python before running the program.
...
Copyright © 2025 Matheus Fernando(https://github.com/B4D1A/)
